namespace UIWidgets.Attributes
{
	...
	public sealed class EditorConditionObjectNotNullAttribute : Attribute, IEditorCondition
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="EditorConditionObjectNotNullAttribute"/> class.
		/// </summary>
		/// <param name="field">Field to check.</param>
		public EditorConditionObjectNotNullAttribute(string field)
		{
			this.field = field;
		}
