namespace UIWidgets
{
	...
	public class DateScroller : DateBase
	{
		...
		/// </summary>
		[SerializeField]
		[EditorConditionBool(nameof(years))]
		...
		/// ScrollBlock for the years.
		/// </summary>
		public ScrollBlockBase YearsScrollBlock => yearsScrollBlock;
		...
		/// </summary>
		[SerializeField]
		[EditorConditionBool(nameof(months))]
		...
		/// ScrollBlock for the months.
		/// </summary>
		public ScrollBlockBase MonthsScrollBlock => monthsScrollBlock;
		...
		/// </summary>
		[SerializeField]
		[EditorConditionBool(nameof(days))]
		...
		/// ScrollBlock for the days.
		/// </summary>
		public ScrollBlockBase DaysScrollBlock => daysScrollBlock;
