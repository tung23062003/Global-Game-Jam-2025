namespace UIWidgets.Menu
{
	...
	/// </summary>
	public partial class ContextMenu : UIBehaviourInteractable, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler
	{
		/// <summary>
		/// Menu instance.
		/// </summary>
		protected class MenuInstance : IMenuSubscriber, IStylable
		{
			...
			protected bool PointerOver
			{
				get
				{
					return (View != null) && View.IsPointerOver;
				}
			}
			...
			public void UpdateItems()
			{
				...
				var layout_size = new LayoutElementData(View.RectTransform);
				var width = layout_size.PreferredWidth;
				var height = layout_size.PreferredHeight;
