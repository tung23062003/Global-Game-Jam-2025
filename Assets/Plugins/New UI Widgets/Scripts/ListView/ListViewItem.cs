...
namespace UIWidgets
{
	...
	public class ListViewItem : UIBehaviourInitiable,
		...
		IMoveHandler, IStylable, IMovableToCache, IUpgradeable
	{
		...
		/// <summary>
		/// Virtual index. Used when the LoopedList enabled.
		/// </summary>
		...
		/// </summary>
		[HideInInspector]
		public ComboboxBase ComboboxOwner;

		/// <summary>
		/// Is belong to the Combobox?
		/// </summary>
		public bool HasComboboxOwner => ComboboxOwner != null;

		/// <summary>
		/// This instance is created and controlled by combobox.
		/// </summary>
		[Obsolete("Replaced with ComboboxOwner and HasComboboxOwner.")]
		public bool ComboboxInstance => HasComboboxOwner;
		...
		public virtual Graphic[] GraphicsBackground
		{
			get
			{
				...
				var style_table = (Owner != null) && Owner.StyleTable && !HasComboboxOwner;
		...
		/// Set the specified color for the graphics.
		/// </summary>
		/// <param name="interactableTint">Interactable color tint.</param>
		public virtual void GraphicsInteractableState(Color interactableTint)
		{
			GraphicsInteractableState(Foregrounds, interactableTint);
			GraphicsInteractableState(Backgrounds, interactableTint);
		}
		...
		/// <param name="graphics">Graphics.</param>
		/// <param name="interactableTint">Interactable color tint.</param>
		protected void GraphicsInteractableState(IList<Graphic> graphics, Color interactableTint)
		{
			if (graphics == null)
			{
				return;
			...
			for (var i = 0; i < graphics.Count; i++)
			{
				...
				g.canvasRenderer.SetColor(interactableTint);
			}
		}
		...
		public virtual bool IsInteractable()
		{
			if (HasComboboxOwner)
			{
				return ComboboxOwner.IsInteractable();
			}

			return (Owner == null) || Owner.IsInteractable();
		}
		...
		protected override void OnRectTransformDimensionsChange()
		{
			...
			if (oldSize.Equals(current) || !gameObject.activeInHierarchy)
			{
				return;
			}
			...
			oldSize = current;
			onResize.Invoke(index, current);

			if (AllowItemsEvents())
			{
				owner.InstancesEventsInternal.Resize.Invoke(index, this, current);
				owner.InstancesEvents.Resize.Invoke(index, this, current);
			}
		}
		...
		public virtual void ResetDimensionsSize()
		{
			...
			if (gameObject.activeInHierarchy)
			{
				...
				Updater.RunOnceNextFrame(this, OnRectTransformDimensionsChangeDelegate);
			}
		}
		...
		{
			return !HasComboboxOwner && (Owner != null) && Owner.IsValid(Index);
		}
		...
		public virtual void SetStyle(StyleImage styleBackground, StyleText styleText, Style style)
		{
			...
			if ((Owner != null) && (Owner.StyleTable) && !HasComboboxOwner)
			{
