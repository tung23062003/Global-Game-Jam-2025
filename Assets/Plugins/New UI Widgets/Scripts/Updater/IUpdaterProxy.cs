namespace UIWidgets
{
	...
	public interface IUpdaterProxy
	{
		...
		void RunOnce(UnityEngine.Object owner, Action action);
		...
		/// <param name="owner">Owner.</param>
		/// <param name="action">Action.</param>
		void RunOnceNextFrame(UnityEngine.Object owner, Action action);
		...
		/// </summary>
		/// <param name="owner">Owner.</param>
		void RemoveRunOnceNextFrameByOwner(UnityEngine.Object owner);
