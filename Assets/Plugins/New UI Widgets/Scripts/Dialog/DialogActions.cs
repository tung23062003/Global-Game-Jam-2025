namespace UIWidgets
{
	...
	public class DialogActions : IList<DialogButton>
	{
		...
		{
			get => GetButton(key).ActionBool;

			set => GetButton(key).ActionBool = value;
		}
		...
		public void Add(KeyValuePair<string, Func<bool>> item) => Add(item.Key, item.Value, 0);
		...
		public void Add(string key, Func<bool> value) => Add(key, value, 0);
...
#pragma warning restore 0618
		...
		[Obsolete("Should not be used.")]
		public bool Contains(KeyValuePair<string, Func<bool>> item) => ContainsKey(item.Key);
		...
		public List<DialogButton>.Enumerator GetEnumerator() => buttons.GetEnumerator();
		...
		IEnumerator<DialogButton> IEnumerable<DialogButton>.GetEnumerator() => buttons.GetEnumerator();
		...
		[Obsolete("Should not be used.")]
		public bool Remove(KeyValuePair<string, Func<bool>> item) => Remove(item.Key);
		...
		public int IndexOf(DialogButton item) => buttons.IndexOf(item);
		...
		public void Insert(int index, DialogButton item) => buttons.Insert(index, item);

		/// <summary>
		/// Removes the element at the specified index of the DialogActions{T}.
		/// </summary>
		/// <param name="index">The zero-based index of the element to remove.</param>
		public void RemoveAt(int index) => buttons.RemoveAt(index);
		...
		public void Add(DialogButton item) => buttons.Add(item);
		...
		/// <param name="item">The object to locate in the DialogActions{T}. The value can be null for reference types.</param>
		public bool Contains(DialogButton item) => buttons.Contains(item);
		...
		public void CopyTo(DialogButton[] array, int arrayIndex) => buttons.CopyTo(array, arrayIndex);
		...
		public bool Remove(DialogButton item) => buttons.Remove(item);
	}
}