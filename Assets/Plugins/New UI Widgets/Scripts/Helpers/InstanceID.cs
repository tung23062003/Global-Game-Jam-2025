namespace UIWidgets
{
	...
	public readonly struct InstanceID : IEquatable<InstanceID>
	{
		...
		public InstanceID(UnityEngine.Object obj) => id = obj.GetInstanceID();

		/// <summary>
		/// Initializes a new instance of the <see cref="InstanceID"/> struct.
		/// </summary>
		/// <param name="id">ID.</param>
		private InstanceID(int id) => this.id = id;
		...
		public static implicit operator int(InstanceID id) => id.id;
		...
		/// <param name="id">ID.</param>
		[System.Obsolete("int replaced with InstanceID.")]
		public static implicit operator InstanceID(int id) => new InstanceID(id);
		...
		public static bool operator ==(InstanceID a, InstanceID b) => a.id == b.id;
