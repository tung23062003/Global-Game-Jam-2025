namespace UIWidgets.WidgetGeneration
{
	...
	public abstract class TestBase<T> : MonoBehaviour
	{
		...
		/// </summary>
		protected virtual bool CanGenerateItems => true;

		/// <summary>
		/// Toggle Theme Blue.
		/// </summary>
		public void ToggleThemeBlue() => ToggleTheme("Blue");

		/// <summary>
		/// Toggle Theme Red.
		/// </summary>
		public void ToggleThemeRed() => ToggleTheme("Red");

		/// <summary>
		/// Toggle Theme Dark.
		/// </summary>
		public void ToggleThemeDark() => ToggleTheme("Dark");

		/// <summary>
		/// Toggle Theme Legacy.
		/// </summary>
		public void ToggleThemeLegacy() => ToggleTheme("Legacy");

		/// <summary>
		/// Toggle Theme.
		/// </summary>
		/// <param name="variation">Variation name.</param>
		public void ToggleTheme(string variation) => Theme.SetActiveVariation(variation);

		/// <summary>
		/// Set default style.
		/// </summary>
		public void SetDefaultStyle() => StyleDefault.ApplyTo(RootCanvas);

		/// <summary>
		/// Set blue style.
		/// </summary>
		public void SetBlueStyle() => StyleBlue.ApplyTo(RootCanvas);
