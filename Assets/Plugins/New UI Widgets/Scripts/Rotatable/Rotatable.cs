namespace UIWidgets
{
	...
	public class Rotatable : UIBehaviourInteractable,
		...
		ILateUpdatable
	{
		...
		[EditorConditionBool(nameof(LimitRotation))]
		[Range(-180f, 180f)]
		float angleMin = -180f;
		...
		public float AngleMin
		{
			...
			set => angleMin = Mathf.Clamp(value, -180f, 180f);
		}
		...
		public float AngleMax
		{
			...
			set => angleMax = Mathf.Clamp(value, -180f, 180f);
		}
		...
		public float AngleStep
		{
			...
			set => angleStep = Mathf.Clamp(value, 0f, 180f);
		}
		...
		/// </summary>
		[SerializeField]
		[EditorConditionBlock(nameof(Cursors))]
		...
		/// </summary>
		public RotatableEvent OnTargetChanged = new RotatableEvent();
