namespace UIWidgets
{
	...
	public class AudioPlayer : MonoBehaviourInitiable, IStylable, IUpdatable
	{
		/// <summary>
		...
		/// </summary>
		public bool IsUsedCurrentClip => (Source.clip != null) && (CurrentClip != null) && (Source.clip.GetInstanceID() == CurrentClip.GetInstanceID());
