...
namespace UIWidgets
{
	...
	public static class ScriptingDefineSymbols
	{
		...
		static HashSet<string> Symbols(BuildTargetGroup target)
		{
			return Compatibility.GetScriptingDefineSymbols(target);
		}
		...
		{
			Compatibility.SetScriptingDefineSymbols(target, symbols);
			AssetDatabase.Refresh();
		}
	}
}
