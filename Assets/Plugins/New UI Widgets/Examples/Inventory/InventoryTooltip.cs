namespace UIWidgets.Examples.Inventory
{
	...
	public class InventoryTooltip : Tooltip<Item, InventoryTooltip>
	{
		...
		/// Highlighted item.
		/// </summary>
		public Item HighlightedItem => CurrentData;
		...
		{
			get => highlightedValueHigher;

			set => highlightedValueHigher = value;
		}
		...
		{
			get => highlightedValueLower;

			set => highlightedValueLower = value;
		}
