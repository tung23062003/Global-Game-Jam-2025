namespace UIWidgets.Examples
{
	...
	public class TestLayoutSwitcher : MonoBehaviour
	{
		...
		{
			using var _ = ListPool<UILayout>.Get(out var filtered);
			FilterLayouts(layouts, aspectRatio, filtered);
		...
		protected static void FilterLayouts(List<UILayout> layouts, float aspectRatio, List<UILayout> output)
		{
