namespace UIWidgets.Examples.Shops
{
	...
	/// JRPG shop.
	/// </summary>
	public class JRPGShop : MonoBehaviourInitiable, IUpgradeable
	{
		Trader Shop;
		...
		protected override void InitOnce()
		{
			...
			Shop.Inventory.AddRange(new Item[]
			{
				new Item("Sword", 10),
			...
			Player.Inventory.AddRange(new Item[]
			{
				new Item("Stick", 1),
				new Item("Sword", 1),
...
#pragma warning disable 0612, 0618
			Utilities.RequireComponent(ShopTotal, ref ShopTotalAdapter);
			Utilities.RequireComponent(PlayerMoney, ref PlayerMoneyAdapter);
			Utilities.RequireComponent(PlayerTotal, ref PlayerTotalAdapter);
