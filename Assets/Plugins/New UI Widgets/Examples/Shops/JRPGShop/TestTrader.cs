namespace UIWidgets.Examples.Shops
{
	...
	/// Test trader.
	/// </summary>
	public class TestTrader : MonoBehaviourInitiable
	{
		/// <summary>
		/// TraderListView.
		/// </summary>
		...
		protected static ObservableList<JRPGOrderLine> CreateOrderLines(IList<Item> items)
		{
		...
		protected override void InitOnce()
		{
			...
			TraderListView.DataSource.AddRange(CreateOrderLines(new Item[]
			{
				new Item("Sword", 10),
		...
		public void AddPlaylistDialog()
		{
			...
			dialog.TryGetComponent<PlaylistDialogHelper>(out var helper);
