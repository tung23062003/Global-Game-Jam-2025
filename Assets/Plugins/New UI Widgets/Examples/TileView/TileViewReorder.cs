namespace UIWidgets.Examples
{
	...
	public class TileViewReorder : MonoBehaviour
	{
		...
		protected virtual void Start()
		{
			...
			OriginalItems.OnChangeMono.AddListener(ReorderItems);
		...
		{
			OriginalItems?.OnChangeMono.RemoveListener(ReorderItems);

			if ((Tiles != null) && (Tiles.ScrollRect != null) && Tiles.ScrollRect.TryGetComponent<ResizeListener>(out var listener))
			{
