namespace UIWidgets.Examples
{
	...
	public class TestTreeGraph : MonoBehaviour
	{
		...
		{
			Nodes = GenerateTreeNodes(new int[] { 1, 3, 2, }, isExpanded: true);
		}
		...
		public static ObservableList<TreeNode<TreeViewItem>> GenerateTreeNodes(IList<int> items, string nameStartsWith = "Node ", bool isExpanded = true, int start = 0)
		{
