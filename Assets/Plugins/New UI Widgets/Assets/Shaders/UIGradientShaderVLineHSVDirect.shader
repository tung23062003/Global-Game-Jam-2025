...
Shader "Custom/New UI Widgets/GradientShaderVLineHSVDirect"
{
	Properties
	{
		// Sprite texture
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				color = color * lerpHSV(_ColorBottom, _ColorTop, IN.texcoord.y);
				#else
				color = color * lerpHSV(LinearToGammaSpace4(_ColorBottom), LinearToGammaSpace4(_ColorTop), IN.texcoord.y);
